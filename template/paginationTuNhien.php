<?php
    ...
    $query = mysqli_query($conn,"SELECT * FROM `sanpham` WHERE DanhMuc = 'Giày đinh sân cỏ tự nhiên' ORDER BY 'MaSP' ASC LIMIT $star_from, $limit ");
    $output .='
    <div class="products">
   ';
...
//pagination
$query = mysqli_query($conn,"SELECT * FROM `sanpham` WHERE DanhMuc = 'Giày đinh sân cỏ tự nhiên'");
