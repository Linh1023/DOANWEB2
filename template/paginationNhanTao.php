...
if($page > 1){
    $previous = $page - 1;
    $output .= '<li class="page-item" id="1"><span class="page-link">frist</span></li>';
    $output .= '<li class="page-item" id="'.$previous.'"><span class="page-link"><i class="bi bi-chevron-double-left"></i></span></li>';
}
...
if($page < $total_page){
    $page++;
    $output .= '<li class="page-item" id="'.$page.'"><span class="page-link"><i class="bi bi-chevron-double-right"></i></span></li>';
    $output .='<li class="page-item" id="'.$total_page.'"><span class="page-link">last</span></li>';
}
$output .= '</ul>';
echo $output;
?>
