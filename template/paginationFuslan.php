<?php
    ...
    $query = mysqli_query($conn,"SELECT *,hang.Ten AS TenHang FROM sanpham,hang WHERE sanpham.MaHang = hang.MaHang AND MaDM = 'DM-4' ORDER BY 'MaSP' ASC LIMIT $star_from, $limit ");
    $output .='
    <div class="products">
   ';
...
//pagination
$query = mysqli_query($conn,"SELECT * FROM `sanpham` WHERE MaDM = 'DM-4'");
