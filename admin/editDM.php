                ...
                <div id="main" class="col col-12 col-lg-10 col-md-10 ">
                    ...
                    <div id="content" class="row" style="background-color:#f0f5f8;height:calc(100% - 72px)">
                        <div class="main mx-auto ">
                            ...
                            if (isset($_GET['id'])) {
                                $id = $_GET['id'];
                                echo '<div class="row justify-content-center display-4">Sửa Danh Mục</div>';
                            ...
                            // Thêm sản phẩm
                                ...
                                echo '<div class="row justify-content-center display-4">Thêm danh mục</div>';
                                $ten = '';
                            }
                            ?>
                            <!-- Tạo form thêm / sửa -->
                            <form action="xuly/xulyEditDM.php" method="post">
                                <div class="row mt-2">
                                    <label class="row">
                                        <div class="col col-3">Tên danh mục:</div>
                                        <div class="col col-9">
